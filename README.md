...
ALTER TABLE "favorite_film" ADD FOREIGN KEY ("film_id") REFERENCES "film" ("film_id");
...
ALTER TABLE "favorite_film" ADD FOREIGN KEY ("user_id") REFERENCES "users" ("user_id");
```
